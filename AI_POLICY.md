...
The fun project has strict rules for AI usage:
...
These rules apply only to outside contributions to fun. Maintainers
...
Please remember that fun is maintained by humans.
...
fun is written with plenty of AI assistance, and many maintainers embrace
